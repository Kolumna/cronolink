  ...
  return (
    <div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card>
          <CardHeader>
            <CardTitle>Terminy projektu</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-2">
              <span>
                ...
                {query.data?.startedAt
                  ? new Date(query.data.startedAt).toLocaleDateString("pl-PL")
                  : "Nie ustawiono"}
              </span>
              <span>
                <strong>Data zakończenia:</strong>{" "}
                {query.data?.finishedAt
                  ? new Date(query.data.finishedAt).toLocaleDateString("pl-PL")
                  : "Nie ustawiono"}
              </span>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Powiązane konta</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-2">
              <div>
                ...
                >
                  {query.data?.githubUrl || "Nie ustawiono"}
                </Link>
              </div>
            </div>
          </CardContent>
